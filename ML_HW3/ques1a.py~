...
#		print j, hidden_layer_input[j].shape
	...
	#print hiddenlayer_activations[-1]
	count = 0
	for s,i in enumerate(hiddenlayer_activations[-1]):
...
f = open('tt_weight.pkl','wb')
pickle.dump(final_weight,f)

f1 = open('tt_bais.pkl','wb')
